        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LabAdmins_AppUser_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabAdminId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Materials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Materials_LabAdmins_LabAdminId",
                        column: x => x.LabAdminId,
                        principalTable: "LabAdmins",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LabAdmins_AppUserId",
                table: "LabAdmins",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LabAdmins_Email",
                table: "LabAdmins",
                column: "Email",
                unique: true);
